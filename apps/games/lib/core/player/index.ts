...
// 타겟 학령 = **중1~고1** (중등 전체 + 고1). 초등은 풀림 주니어(별도 앱)라 제외.
// 근거: proc/plan/2026-06-30_target-middle-to-high1.md (G1 확정 2026-06-30 — 06-26
// "중·고등 전 학년(중1~고3)" 에서 중1~고1 로 정밀화. 고2·고3 제외). 구 grade 값 중
// 초등(초1~초6)·고2·고3 은 isGrade 가 거부 → getPlayer null → 온보딩 재선택으로
// 자연 마이그레이션(프리런치라 실사용자 영향 없음).
export const GRADES = ["중1", "중2", "중3", "고1"] as const;
