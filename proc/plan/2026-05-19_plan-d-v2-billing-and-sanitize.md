...
**D2·D3·D4·D6·D7 합의 권장 순서** (audit v5 §8.3, 2026-05-26): **D4(가격대) → D2(가격 모델) → D3(기능 비교) → D6(환불) → D7(학생 할인)**. D1(2026 Q4) 기준 역산 시 가격 정의 (D4·D2) 가 가장 선행. D3 기능 비교는 D2 모델 따라 가변. D6·D7 는 D2·D4 후. 근거: [`proc/audit/2026-05-26_games-catalog-audit-v5.md`](../audit/2026-05-26_games-catalog-audit-v5.md) §8.3.
