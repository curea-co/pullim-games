...
**D2·D3·D4·D6·D7 합의 권장 순서** (2026-05-26): **D4(가격대) → D2(가격 모델) → D3(기능 비교) → D6(환불) → D7(학생 할인)**. D1(2026 Q4) 기준 역산 시 가격 정의 (D4·D2) 가 가장 선행. D3 기능 비교는 D2 모델 따라 가변. D6·D7 는 D2·D4 후. 근거: D1 V2=2026 Q4 합의 기준 역산 + V1 → V2 가격 정의가 다른 결정점의 선제 조건이라는 의존도 분석. (audit v5 본 doc §8.3 의 동일 권장 순서는 별 PR #102 머지 후 main 에서 교차 확인 가능 — 본 PR(#103) diff 에는 미포함.)
