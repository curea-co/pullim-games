...
- **연관**: `proc/plan/2026-05-19_plan-d-v2-billing-and-sanitize.md`, `proc/spec/05-비즈니스-정책.md §5.7`, PR #105 (spec/01 §3 정합화, 동일 패턴) — 본 plan 작성 시점 기준 PR #105 는 진행 중. 머지 시점에 archive 이관되며 그 후 경로는 `proc/archive/plan/2026-05-20_plan-g-phase17-spec-01-section3-followup.md`.
...
- [ ] D1·D2 사용자 합의
- [ ] `proc/spec/01-AI-명령지침.md:36` 갱신 — §1.B 의 PII 예외 조항 신설
- [ ] `proc/spec/09-기술-환경.md:20,42-45,209` 갱신 — 이메일 수집 트리거 예외 명시
