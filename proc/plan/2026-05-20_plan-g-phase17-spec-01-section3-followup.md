...
- **연관**: `proc/archive/plan/2026-05-20_plan-g-pullim-workflow-port.md` (PR #105 머지로 archive 이관 완료, 2026-05-26 main 반영).
- **본 PR #103 에서 완료된 정합화**: `AGENTS.md` L4·L13 의 plan-g-port 경로 참조는 본 PR #103 에서 이미 `proc/archive/plan/2026-05-20_plan-g-pullim-workflow-port.md` 로 갱신 완료. CLAUDE.md §9 L140 의 plan-g-port 참조도 동일하게 archive 경로로 갱신 완료. plan-g-port archive 이관에 따른 stale 참조 fix 는 본 PR scope 내에서 모두 종결.
- **잔여 이슈 (본 plan §3 작업항목)**: `AGENTS.md` L4·L13 의 spec/01 §3 우회 선언 본문 (예: "본 리포 환경에서는 적용 불가") 제거 + spec/01 §3·spec/09 §9.1·§9.6 본문 갱신. **G3·G4 합의 보류로 scope 축소** 되어 본 plan §3 작업항목의 spec/01 §3·spec/09 §9.1·§9.6·AGENTS.md 본문 갱신은 미수행 — D2 합의 완료 후 별 PR 로 정합화.
