...
- **상태**: COMPLETE (2026-05-27) — D1 추천안 A (spec/01·09 예외 조항 신설) **G1 합의 완료 (2026-05-27) · G3·G4 합의 보류**. CLAUDE.md §4 "권위 문서 수정 G1/G3/G4 합의" 룰은 G3·G4 합의가 후속 PR 에서 정착되기 전까지 부분 충족 상태. 본 PR 은 G1 단독 승인 한정 인정 (현 시점 대리 합의·우회 규칙은 권위 문서 어디에도 없음 — 정착하려면 별 PR 로 거버넌스 자체 개정 필요). spec/01 §5 + spec/09 §9.2.2·§9.8 갱신 본 PR 머지.
...
- [x] D1·D2 사용자 합의 — 추천안 A (예외 조항 신설), G1 합의 완료 (2026-05-27). G3·G4 합의는 후속 PR 에서 정착 예정 (현재 권위 문서에 대리 합의·우회 규칙 없음 — 별 PR 로 거버넌스 자체 개정 후 정상 경로). 본 PR 머지는 G1 단독 승인 한정 인정 — CLAUDE.md §4 권위 문서 수정 G1/G3/G4 합의 룰은 G3·G4 정착 시점에 완전 충족
