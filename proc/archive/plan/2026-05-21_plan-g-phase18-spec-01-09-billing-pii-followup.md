...
- **상태**: COMPLETE (2026-05-27) — D1 추천안 A (spec/01·09 예외 조항 신설) **G1·G3·G4 합의 완료** (CLAUDE.md §4 "권위 문서 수정 G1/G3/G4 합의" 룰 준수 — G1 이 4 풀림 단일 owner 권한으로 G3·G4 명목 대리 합의, 2026-05-27 사용자 명시 결정). spec/01 §5 + spec/09 §9.2.2·§9.8 갱신 본 PR 머지.
...
- [x] D1·D2 사용자 합의 — 추천안 A (예외 조항 신설), G1·G3·G4 합의 완료 (2026-05-27). G1 이 4 풀림 단일 owner 권한으로 G3·G4 명목 대리 합의 — 본 리포 한정 PII 예외 조항 (다른 풀림 프로젝트 영향 0) 이라 대리 합의 정당. CLAUDE.md §4 권위 문서 수정 G1/G3/G4 합의 룰 충족
