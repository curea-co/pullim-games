// 미진행 게임 썸네일 그리드 — 다양성 보강.
// `2026-05-08_home-dashboard-redesign.md` §6.2-D.
          ...
          return (
            <li key={stat.gameId}>
              <Link
                ...
                className="group flex aspect-square flex-col items-center justify-center gap-1.5 rounded-block border border-border-hairline bg-bg-block p-2 text-center opacity-65 transition-colors hover:border-type-primary/30 hover:opacity-100"
              >
                <span
                  aria-hidden="true"
