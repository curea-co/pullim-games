...
- [ ] 카드 셔플 — deterministic seed 기반 (테스트 안정성, english-order 패턴 차용)
- [ ] 매칭 인터랙션 — 한쪽 카드 탭 → 반대쪽 카드 탭. 짝이면 fade-out + scale 결합 애니메이션
- [ ] 오답 시 두 카드 동시에 빨강 + shake (32px)
- [ ] 5장 카드 sample (수능 어휘 빈도 상위)
- [ ] FSRS 통합 — pair 단위로 카드 풀 관리
